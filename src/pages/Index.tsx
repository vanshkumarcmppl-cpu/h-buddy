        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of organizations using CyberSecure Portal to protect their digital assets
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-8 text-sm text-muted-foreground">
              ...
              <Button asChild variant="link" className="text-muted-foreground hover:text-primary p-0">
                <Link to="/admin/login">
                  Admin Portal
                </Link>
              </Button>
